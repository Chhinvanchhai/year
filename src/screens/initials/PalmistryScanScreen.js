    ...
    Alert.alert(i18n.t("Lets start with the left hand"), null, [
      {
        ...
        onPress: () =>
          Alert.alert(
            ...
            i18n.t("Wait a couple of seconds while it detects your hand"),
  ...
  return (
    <DefaultView barStyle={useIsDark() ? "light-content" : "dark-content"}>
      ...
      {!hasPermission ? (
        <View style={styles.cameraContainer}>
          <Text style={{ color: colors.error }}>
            {i18n.t("There's no permission to use the camera")}
          </Text>
        </View>
      ) : (
        <Camera
          pictureSize={pictureSize}
          onCameraReady={_handleCameraReady}
      ...
      <View style={styles.progressContainer}>
        ...
        <ProgressBar progress={steps * 0.2} style={styles.progressBar} />
        <Button
          onPress={() =>
            navigation.reset({
              index: 0,
